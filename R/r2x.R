...
#'
#' This is shortcut function to create a single value with a number of
#' attributes set.
#'
#' Thsi function is also used by the R code generated by the functions
#' r2x_deparse and x2r.
#'
#' @param ... Named arguments to be used as attributes on the value.
#' @param val Some value. Since this argument follows triple-dots
#'     list, it must be named.
#' @return The value with the atributes given by list(...) appended to
#'     the existing list of attributes.
#' @examples
